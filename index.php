            ...
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    ...
                    <button type="button" name="" id=""
                        class="col-12 col-md-4 btn btn-primary py-2 px-3 fw-bold text-white fs-4"> Shop Now
                        <i class="bx bx-right-arrow-alt bx-sm"></i>
                    </button>
                    <!-- Search bar -->
                    <!-- <div class="position-relative mx-auto">
                        <input class="form-control border-2 border-gray w-75 py-3 px-4 rounded-pill" type="number" placeholder="Write what you want?">
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" slides-per-view="auto" space-between="5" free-mode="true">
                    <swiper-slide>
                        <a class="card shadow m-md-4" href="#">
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <div class="row justify-content-center align-items-center g-2">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="rounded-2">
                            <div class="card shadow m-md-4" href="#">
                                ...
                                <div class="overlay text-center">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <button type="button" class="btn btn-outline-primary sahdow">Shop Now <i class="bx bx-right-arrow-alt"></i></button>
                                        </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="p-4 rounded-bottom">
                        ...
                        <div class="d-flex justify-content-between flex-lg-wrap">
                            <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                            <a href="assets/#" class="btn border border-secondary rounded-pill px-3 text-primary"><i
