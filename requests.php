                                        ...
                                        <div class="order-details border border-gray border-1 rounded-2 p-3">
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <a class="btn btn-primary fw-bold" type="button" href="requests.php?soid=<?= $specialorder['SOID'] ?>" data-bs-toggle="modal" data-bs-target="#contract-modal">Approve</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="assets/php/request.php" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="soid" value="<?= $specialorder['SOID'] ?>" />
                                                <input type="hidden" name="sonumber" value="<?= $specialorder['SONUMBER'] ?>" />
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="" class="form-label">CHOOSE FILE:</label>
                                                        <fieldset class="upload_dropZone text-center mb-3 p-4">
                                                            <p class="small my-2">Drag and Drop File</p>
                                                            <input id="contract_file" class="position-absolute invisible" type="file" name="contract_file" multiple accept="image/*,.pdf" />
                                                ...
                                                <div class="modal-footer">
                                                    <button type="reset" class="btn btn-accent fw-bold" data-bs-dismiss="modal">Later</button>
