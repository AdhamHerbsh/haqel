    ...
    $uspecial_orders = $result->fetch_all(MYSQLI_ASSOC);

    // Prepare SQL to fetch user and account data
    $stmt = $conn->prepare("SELECT *  FROM special_orders WHERE SOSTATUS = 'applied' AND WS_ID = ?");
                ...
                <div class="container-fluid requests">
                    <div class="container py-5">
                        <div class="section-title mb-5">
                            <h1>Active Special Orders</h1>
                            <h3 class="text-muted"> See Details Of Special Orders</h3>
                        </div>
                        <div class="section-title mb-3">
                            All Special Orders Unapproved Yet!
                        </div>
                        <div class="table-responsive overflow-md-hidden mb-3">
                            <table class="table table-hover" id="ordersTable">
                                ...
                                <tbody>
                                    <?php foreach ($uspecial_orders as $uspecialorder) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a type="submit" class="btn btn-accent" href="assets/php/request.php?soid=<?= $uspecialorder['SOID'] ?>">Cancle <i class='bx bx-message-x'></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
